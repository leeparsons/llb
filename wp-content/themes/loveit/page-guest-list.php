...
?><div class="clear-with-margin"></div><a name="location"></a><?php
    ...
    */
    ...
    if (count($guests) > 0) {
        ...
        ?><section class="twit-feed"><article class="twit-feed"><header class="article-header"><h2 class="no-link article-title">Guest List<span class="time" style="float:right;font-size:22px;width:auto">
