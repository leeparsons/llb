 ...
 */
	...
	if (!empty($query) && isset($_POST['aid'])) {
        ...
        $fields = array(								
                        ...
                        'PAYMENTACTION'								=>	'Sale',
                        'PAYMENTREQUEST_0_AMT'						=>	$query[0]->price,
                        'PAYMENTREQUEST_0_ITEMAMT'					=>	$query[0]->price,
                        'PAYMENTREQUEST_0_TAXAMT'					=>	'0.00',
                        'PAYMENTREQUEST_0_SHIPPINGAMT'				=>	'0.00',
                        'PAYMENTREQUEST_0_HANDLINGAMT'				=>	'0.00',
                        'PAYMENTREQUEST_0_INSURANCEAMT'				=>	'0.00',
                        'PAYMENTREQUEST_0_CURRENCYCODE'				=>	'GBP',
                        'L_PAYMENTREQUEST_0_NAME0'					=>	'Advert Signup: ' . $query[0]->duration,
                        'L_PAYMENTREQUEST_0_DESCRIPTION0'			=>	$query[0]->description,
                        'L_PAYMENTREQUEST_0_AMT0'					=>	$query[0]->price,
        ...
        $message .= '<p>We just need payment from you to start your advert, if you have not don so already, you can visit this link to make payment at any point for your advert to go live: <a href="http://' . $_SERVER['SERVER_NAME'] . '/advertise/advert-preview/?aid=' . $query[0]->aid . '">http://' . $_SERVER['SERVER_NAME'] . '/advertise/advert-preview/?aid=' . $query[0]->aid . '</a></p>';
        ...
        $message .= '<p>Your advert has been booked for: <br/>' . $query[0]->duration . ' at a cost of &pound;' . $query[0]->price . '</p>';
...
?>
                <p><input type="submit" class="submit-payment fl" value="continue to payment"/><img src="/images/paywithpaypal.png" style="margin-top:-25px" alt="paypal"/><br/></p>
<?php
} else {
...
?>
                <p><input type="submit" class="submit-payment fl" value="continue to payment"/><img src="/images/paywithpaypal.png" style="margin-top:-25px" alt="paypal"/></p>
<?php
} else {
	?><p>Payment has been made, thank you</p><?php
}
