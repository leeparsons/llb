<section class="col2">
<div class="s-left"></div><div class="s-right">
...
<?php
    ...
    <?php
        ...
        if (is_dynamic_sidebar('sidebar-1') &&  count($sidebars_widgets['sidebar-1']) > 0) {
            ?><aside><h3 class="widget-title sponsors">Sponsors</h3></aside><?php
            ...
            <?php
                ...
                if (have_posts()) {
                    ...
                    while (have_posts()) {
                        ...
                        love_image_cache('small-thumb', 92, 's-tmb', true, ($c%2 == 0) ? 'c' : 'l', $title, get_field('thumbnail'), true);
                    }
