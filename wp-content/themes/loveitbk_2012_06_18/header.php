...
<link rel="stylesheet" type="text/css" media="all" href="/wp-content/themes/loveit/style.css?v=1" />
<?php
    if ($isMobile === true) {
	...
	<header>
        <hgroup>
            <?php
                ...
                ?>
            <h1 id="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home" class="site-title"><?php echo the_title() . ' - '; bloginfo( 'name' ); ?></a></h1>
            <?php
...
<li class="s"><a href="<?php echo bloginfo('rss2_url'); ?>" class="rss"></a></li>
                <li class="s"><a href="http://twitter.com/LuxeRosie/" class="twitter"></a></li>
