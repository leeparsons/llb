...
function _wp_post_thumbnail_html( $thumbnail_id = NULL ) {
	...
	$content = sprintf($set_thumbnail_link, esc_html__( 'Set featured image' )) . '<br/>Max Width 940px<br/> Max Height 300px<br/><br/>This is used on:<br/>Home Page<br/>Sidebar latest Posts<br/>Thumbnail';
